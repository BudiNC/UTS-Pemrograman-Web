...
<body>
	<section>
		...
		<div class="banner">
			<h1>Aplikasi Sederhana Pemantauan Jumlah Pasien Covid 19</h1>
		</div>

		<h3>Input Data Sesuai Dengan Form dibawah ini</h3>

		<form action="prosescovid19.php" method="post">
			...
			<center>
				<table width="100%">
					...
					<?php 
							...
							$txt_file = file_get_contents("datapasiencovid19.txt");
							$rows = explode("\n", $txt_file);
							array_shift($rows);
							$i=1;
